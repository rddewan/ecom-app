...
abstract class AppLocales {
  ...
  static const ne = LangVo("नेपाली", "Nepali", "ne", Locale("ne"), "🇳🇵");
  static const hi = LangVo("हिन्दी", "Hindi", "hi", Locale("hi"), "🇮🇳");
  static const available = <LangVo>[en,ja,ne,hi];
  static List<Locale> get supportedLocales => [en.locale,ja.locale,ne.locale,hi.locale];
